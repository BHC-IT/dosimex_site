export const en = {
	...
	software: {
		...
		more: {
			...
			links: [
				{ label: 'Dosimex-GX user manuals', href: '/en/manuals' },
				{ label: 'Complete validation files', href: '/en/manuals' },
				{ label: 'Gamma source validation extracts', href: '/en/manuals' },
				{ label: 'X-ray generator validation', href: '/en/manuals' },
				{ label: "What's new in Dosimex-GX 3.2", href: '/en/manuals' },
				{ label: 'Our reading selection', href: '/en/books' },
			],
		},
		ask: {
			title: 'Any questions?',
