...
const text: ILang = {
	...
	Software: {
		...
		packOpe: {
			...
			liTitles: [
				'{Software.packOpe.liTitle[0]}',
				'{Software.packOpe.liTitle[1]}',
				'{Software.packOpe.liTitle[2]}',
				'{Software.packOpe.liTitle[3]}',
				'{Software.packOpe.liTitle[4]}',
			],
			li: [
		...
		packPeda: {
			...
			liTitles: [
				'{Software.packPeda.liTitle[0]}',
				'{Software.packPeda.liTitle[1]}',
				'{Software.packPeda.liTitle[2]}',
				'{Software.packPeda.liTitle[3]}',
			],
			li: [
		...
		packMes: {
			...
			liTitles: [
				'{Software.packMes.liTitle[0]}',
				'{Software.packMes.liTitle[1]}',
				'{Software.packMes.liTitle[2]}',
				'{Software.packMes.liTitle[3]}',
			],
			li: [
	...
	Books: {
		...
		books: [
			{ extract: '{Books.books[0].extract}', author: '{Books.books[0].author}' },
	...
	Manuals: {
		header: {
			...
			p: '{Manuals.header.p}',
			li: ['{Manuals.header.li[0]}', '{Manuals.header.li[1]}', '{Manuals.header.li[2]}'],
		},
		manuals: [
			'{Manuals.manuals[0]}',
			'{Manuals.manuals[1]}',
	...
	Footer: {
		...
		col2: {
			...
			p: ['{Footer.col2.p[0]}', '{Footer.col2.p[1]}', '{Footer.col2.p[2]}'],
		},
		col3: {
			title: '{Footer.col3.title}',
			p: ['{Footer.col3.p[0]}', '{Footer.col2.p[1]}', '{Footer.col2.p[2]}'],
		},
	},
	Navbar: {
		items: [
