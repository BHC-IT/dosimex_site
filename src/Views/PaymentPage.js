...
\n\
Cette clé fonctionne comme un dongle. Il suffit de la logger sur un PC pour automatiquement voir apparaitre l’ensemble des dossiers (DOSIMEX 3.0 (E ) ).\n\
...
Il faudra par contre dans ce cas que la clé Dosimex reste logée sur le PC.\n\
