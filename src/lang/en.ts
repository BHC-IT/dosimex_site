...
const text : ILang = {
	...
	About: {
		...
		gerald: {
			...
			pBorder: ["2013 - 2015: monitoring of the dismantling of the UP2-400 production unit in the High Activity sector. Specific follow-up of the dismantling worksite of a fuel dissolver type UNGG.",
	...
	Manuals: {
		...
		internships: [	"End of study internships reports vs Dosimex",
