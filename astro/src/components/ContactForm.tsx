...
const inputClass =
	'mt-1.5 block w-full bg-white dark:bg-secondary border-[1.5px] border-input-strong aria-invalid:border-destructive rounded-[8px] px-4 py-3 text-foreground placeholder:text-foreground/55 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/25 transition-colors'
