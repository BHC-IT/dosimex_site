...
const PartImagePortrait = styled.div<PartImageProps>`
	width: 50vw;
	height: 22vh;
	flex-shrink: 0;
	margin-right: 1.5vw;
...
const Articles = (props: any) => {
	...
	if (!props.articles || props.articles === undefined || props.articles.length === 0) return null
					...
					return (
						...
						>
							{props.isPortrait ? (
								<PartImagePortrait
									imageUrl={
										e.urlImage || '/Images/BackGroundHague2_compressed.png'
									}
								/>
							) : (
								<PartImage
