	...
	return (
		<div>
			<div className='container'>
				<div style={styles.divInput}>
					<Input
						...
						validator={
							[
								{
									validationFunction: (value: string) => isInputValid(value),
				...
				<p style={{ textTransform: 'uppercase', color: 'var(--grey)', fontSize: '2rem' }}>
					{text.label_markdown}
				</p>
				<MDEditor
					value={markdown}
							...
							if (props.method === 'POST') {
								try {
									...
									if (axios.isAxiosError(e))
										toast.error(
											`Echec de l\'envoi du nouvel article - ${e.response?.data.message}`
										)
									else toast.error("Echec de l'envoi du nouvel article")
								} finally {
									setIsLoading(false)
								}
